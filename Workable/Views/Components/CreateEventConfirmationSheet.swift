...
/// First-step confirmation shown before entering the existing Create Event flow.
struct CreateEventConfirmationSheet: View {
    static let suppressConfirmationAppStorageKey = "candidateProfile.suppressCreateEventAgentConfirmation"
    ...
    private var explanation: String {
        "Creating an event from here means the AI agent will stop for \(candidateFirstName), and you will take over scheduling communication."
    }
            ...
            GeometryReader { geo in
                ScrollView {
                    VStack(spacing: 0) {
                        ...
                        Text("Schedule event and take over")
