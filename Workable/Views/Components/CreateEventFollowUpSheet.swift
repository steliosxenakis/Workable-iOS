...
/// Follow-up confirmation shown after pressing "Schedule event & take over" in the Create Event flow.
struct CreateEventFollowUpSheet: View {
    ...
    private var explanation: String {
        "The AI agent conversation and invitation will stop for \(candidateFirstName) after scheduling. You can still continue communication manually."
    }
            ...
            GeometryReader { geo in
                ScrollView {
                    VStack(spacing: 0) {
                        ...
                        Text("Schedule event without take over?")
