...
/// Follow-up confirmation shown after pressing "Continue to email" in the Send Email flow.
struct SendEmailFollowUpSheet: View {
    ...
    private var explanation: String {
        "The AI agent conversation and invitation will stop for \(candidateFirstName) after sending. You can still continue communication manually."
    }
            ...
            GeometryReader { geo in
                ScrollView {
                    VStack(spacing: 0) {
                        ...
                        Text("Send email without take over?")
