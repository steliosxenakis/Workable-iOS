...
/// Final irreversible confirmation in send text flow.
struct SendTextFinalConfirmationSheet: View {
    ...
    private var explanation: String {
        "You are about to send a text to \(candidateFirstName). The candidate will remain in the current stage and communication will continue manually."
    }
...
#Preview {
    SendTextFinalConfirmationSheet(
        candidate: Candidate(
            name: "Rachael",
            role: "Designer",
